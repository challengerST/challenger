            ...
            switch (n) {
                ...
                case 2:
                    self.aniDiv.show().children().hide().each(function (index) {
                        var delay = index * 30;
                        $(this).css({opacity: 0.1}).show().delay(delay).animate({
                            opacity: 1,
                            "width": aWidth,
                            "height": aHeight
                        }, 200, 'linear', function () {
                ...
                case 3:
                    self.aniDiv.show().children("div:lt(5)").hide().each(function (index) {
                        ...
                        $(this).css({opacity: 0.1, "width": aWidth}).show().delay(delay).animate({
                            opacity: 1,
                ...
                case 4:
                    self.aniDiv.show().children().hide().each(function (index) {
                        ...
                        $(this).css({opacity: 0.1, "height": "100%"}).show().delay(delay).animate({
                            opacity: 1,
                            "width": gap.width
                ...
                case 5:
                    self.aniDiv.show().children().show().each(function (index) {
                        ...
                        $(this).css({
                            ...
                            "width": gap.width,
                            "opacity": 0.01
                        }).delay(delay).animate({"opacity": 1}, self.options.animationSpeed, function () {
                            if (self.aniDiv.find(" div").index(this) == 24) {
                                self.finishAnimating(data);
                            }
                        });
