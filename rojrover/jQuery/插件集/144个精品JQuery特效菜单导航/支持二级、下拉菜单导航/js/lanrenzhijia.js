...
function initHeaderOperate()
{
    ...
    if(usernick=="")
        xinshou = "<a name=\"ddnav_login\" href=\"https://login.dangdang.com/Signin.aspx\" target=\"_self\" class=\"login_link\">登录</a><a name=\"ddnav_register\" href=\"https://login.dangdang.com/Register.aspx\" target=\"_self\" class=\"login_link\">免费注册</a>";
    else
    {
