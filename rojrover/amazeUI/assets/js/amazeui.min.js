...
!function (t, e) {
    ...
    return function (t) {
        ...
        c.DEFAULTS = {
            ...
            className: {
                prevSlide: "am-pureview-slide-prev", nextSlide: "am-pureview-slide-next", onlyOne: "am-pureview-only",
                active: "am-active", barActive: "am-pureview-bar-active", activeBody: "am-pureview-active"
            },
            selector: {
        ...
        function n() {
            ...
            t.each(function (t, i) {
                ...
                a.on("mouseover.accordion.amui", function () {
